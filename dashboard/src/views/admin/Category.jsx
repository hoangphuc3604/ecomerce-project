    ...
    return (
        <div className='px-2 lg:px-7 pt-5'>
            ...
            <div className='flex flex-wrap w-full'>
                ...
                <div className={`w-[320px] lg:w-5/12 translate-x lg:relative lg:right-0 fixed ${show ? 'right-0' : '-right-[340px]'} z-[1000] top-0 transition-all duration-500`}>
                        ...
                        <div className='bg-[#6A5FDF] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#D0D2D6]'>
                            ...
                            <form action="">
                                <div className='flex flex-col w-full gap-1  mb-3'>
                                    ...
                                    <input className='px-4 py-2 outline-none bg-white text-black border border-slate-700 rounded-md' type="text" id='name' name='category_name' placeholder='Category Name'/>
                                </div>
